    ...
    return (
        <div className="bg-white rounded-2xl shadow-xl px-4 py-4 space-y-4 ">
            ...
            <div className="items-center text-left space-y-4">
                ...
                <p className="text-lg text-slate-500 font-light ">{description}</p>
            </div>
            <div className="flex justify-between lg:gap-4">
                <div className="flex flex-1 items-center lg:gap-2">
                    ...
                    <p className="text-sm text-slate-500 font-light ">Price: {price}</p>
                </div>
                <div className="flex flex-1 items-center lg:gap-2">
                    <img src="https://i.ibb.co/PcsTD1f/Frame.png" alt="" />
                    <p className="text-sm text-slate-500 font-light ">Credit: {credit_hour}hr</p>
                </div>
            </div>
            <div className="flex justify-center bg-blue-500 rounded-lg">
                <button onClick={()=>handleSelect(card)} className="text-lg font-bold text-white py-3 px-32">Select</button>
            </div>
        </div>
    );
};
